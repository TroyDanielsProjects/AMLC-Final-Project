...
class DataCleaner:
    ...
    def run(self, clean=True, load=True):
        ...
        """
        data = None
        os.makedirs("/mnt/gemma-scraping/buzz/clean_data", exist_ok=True)
        if clean:
    ...
    def proccess_nhl_buzz_data(self):
        ...
        """
        path = "/mnt/gemma-scraping/buzz/nhl_buzz_data.txt"
        path_to_write = "/mnt/gemma-scraping/buzz/clean_data/clean_nhl_buzz_data.txt"
    ...
    def remove_empty_dates(self, path="/mnt/gemma-scraping/buzz/clean_data/clean_nhl_buzz_data.txt", path_to_write="/mnt/gemma-scraping/buzz/clean_data/usable_buzz_data.txt"):
        """
    ...
    @staticmethod
    def load_buzz_data(path="/mnt/gemma-scraping/buzz/clean_data/usable_buzz_data.txt"):
        """
    ...
    def create_buzz_SFTTrainer_json(self, path="/mnt/gemma-scraping/buzz/clean_data/usable_buzz_data.txt", path_to_write="/mnt/gemma-scraping/buzz/clean_data/clean_buzz_SFT.jsonl"):
        """
        Load and parse NHL Buzz data into structured objects.
    ...
    @staticmethod
    def load_pod_data(path="/mnt/gemma-scraping/spittin-chiclets"):
        """
        Load and parse NHL Buzz data into structured objects.
    ...
    @staticmethod
    def create_pod_SFTTrainer_json(path="/mnt/gemma-scraping/spittin-chiclets", path_to_write="/mnt/gemma-scraping/buzz/clean_data/clean_podcast_SFT.jsonl", max_line=1000):
        """
        Load and parse NHL Buzz data into structured objects.
